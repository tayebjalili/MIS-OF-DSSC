            ...
            <div class="card">
                <div class="card-body">
                    <div class="header-toolbar">
                        <h5 class="card-title mb-0" style="font-size: 14px;">{{ __('messages.specialist_of_affairs_and_sports') }}</h5>

                        <div class="search-box">
                            <form method="GET" action="{{ url('panel/sports') }}" class="d-flex w-100">
                        ...
                        <div class="utility-buttons">
                            ...
                            <button class="filter-toggle-btn {{ request('sport_type') || request('baget') ? 'has-filters' : '' }}" id="filterToggleBtn">
                            ...
                            <form action="{{ route('backup.page', ['page' => 'sports']) }}" method="GET">
                                <button type="submit" class="btn backup-btn">
                                    <i class="bi bi-box-arrow-down"></i> Backup
                                </button>
                            </form>

                            @hasPermission('Add Specialist of Affairs and Sports')
                            <a class="btn btn-success" href="{{ url('panel/sports/add') }}">
                ...
                'order' => (request('sort_by') === 'id' && request('order') === 'asc') ? 'desc' : 'asc'
                                    ...
                                    <th style="width: 150px;">
                                        <a href="{{ route(request()->route()->getName(), array_merge(request()->all(), [
                'sort_by' => 'activity_title',
                'order' => (request('sort_by') === 'activity_title' && request('order') === 'asc') ? 'desc' : 'asc'
            ])) }}"
                                            style="text-decoration: none; color: inherit; display: inline-flex; align-items: center; gap: 4px;">
                                            {{ __('messages.activity_title') }}
                                            <span style="font-size: 12px; color: #888;">
                                                @if(request('sort_by') === 'activity_title')
                                                <span style="color: #6200ee; font-weight: bold;">
                                                    {{ request('order') === 'asc' ? '▲' : '▼' }}
                                                </span>
                                                @else
                ...
                'order' => (request('sort_by') === 'end_date' && request('order') === 'asc') ? 'desc' : 'asc'
                                    ...
                                    <th style="width: 120px;">
                                        <a href="{{ route(request()->route()->getName(), array_merge(request()->all(), [
                'sort_by' => 'sports_teams',
                'order' => (request('sort_by') === 'sports_teams' && request('order') === 'asc') ? 'desc' : 'asc'
            ])) }}"
                                            style="text-decoration: none; color: inherit; display: inline-flex; align-items: center; gap: 4px;">
                                            {{ __('messages.sports_teams') }}
                                            <span style="font-size: 12px; color: #888;">
                                                @if(request('sort_by') === 'sports_teams')
                                                <span style="color: #6200ee; font-weight: bold;">
                                                    {{ request('order') === 'asc' ? '▲' : '▼' }}
                                                </span>
                                                @else
                                    ...
                                    <th style="width: 100px;">
                                        <a href="{{ route(request()->route()->getName(), array_merge(request()->all(), [
                'sort_by' => 'sport_type',
                'order' => (request('sort_by') === 'sport_type' && request('order') === 'asc') ? 'desc' : 'asc'
            ])) }}"
                                            style="text-decoration: none; color: inherit; display: inline-flex; align-items: center; gap: 4px;">
                                            {{ __('messages.sport_type') }}
                                            <span style="font-size: 12px; color: #888;">
                                                @if(request('sort_by') === 'sport_type')
                                                <span style="color: #6200ee; font-weight: bold;">
                                                    {{ request('order') === 'asc' ? '▲' : '▼' }}
                                                </span>
                                                @else
                                    ...
                                    <th style="width: 80px;">
                                        <a href="{{ route(request()->route()->getName(), array_merge(request()->all(), [
                'sort_by' => 'baget',
                'order' => (request('sort_by') === 'baget' && request('order') === 'asc') ? 'desc' : 'asc'
            ])) }}"
                                            style="text-decoration: none; color: inherit; display: inline-flex; align-items: center; gap: 4px;">
                                            {{ __('messages.baget') }}
                                            <span style="font-size: 12px; color: #888;">
                                                @if(request('sort_by') === 'baget')
                                                <span style="color: #6200ee; font-weight: bold;">
                                                    {{ request('order') === 'asc' ? '▲' : '▼' }}
                                                </span>
                                                @else
                                    ...
                                    <th style="width: 200px;">
                                        <a href="{{ route(request()->route()->getName(), array_merge(request()->all(), [
                'sort_by' => 'activity_established_research_findings',
                'order' => (request('sort_by') === 'activity_established_research_findings' && request('order') === 'asc') ? 'desc' : 'asc'
            ])) }}"
                                            style="text-decoration: none; color: inherit; display: inline-flex; align-items: center; gap: 4px;">
                                            {{ __('messages.activity established research findings') }}
                                            <span style="font-size: 12px; color: #888;">
                                                @if(request('sort_by') === 'activity_established_research_findings')
                                                <span style="color: #6200ee; font-weight: bold;">
                                                    {{ request('order') === 'asc' ? '▲' : '▼' }}
                                                </span>
                                                @else
                                    ...
                                    <th style="width: 150px;">
                                        <a href="{{ route(request()->route()->getName(), array_merge(request()->all(), [
                'sort_by' => 'considerations',
                'order' => (request('sort_by') === 'considerations' && request('order') === 'asc') ? 'desc' : 'asc'
            ])) }}"
                                            style="text-decoration: none; color: inherit; display: inline-flex; align-items: center; gap: 4px;">
                                            {{ __('messages.considerations') }}
                                            <span style="font-size: 12px; color: #888;">
                                                @if(request('sort_by') === 'considerations')
                                                <span style="color: #6200ee; font-weight: bold;">
                                                    {{ request('order') === 'asc' ? '▲' : '▼' }}
                                                </span>
                                                @else
                ...
                'order' => (request('sort_by') === 'content' && request('order') === 'asc') ? 'desc' : 'asc'
                                    ...
                                    @hasPermission('Edit Specialist of Affairs and Sports')
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $value->id }}</td>
                                    <td>{{ $value->activity_title }}</td>
                                    <td>{{ $value->description }}</td>
                                    <td>{{ $value->start_date }}</td>
                                    <td>{{ $value->end_date }}</td>
                                    <td>{{ $value->sports_teams }}</td>
                                    <td>{{ $value->sport_type }}</td>
                                    <td>{{ $value->baget }}</td>
                                    <td>{{ $value->activity_established_research_findings }}</td>
                                    <td>{{ $value->considerations }}</td>
                                    <td>{{ $value->content }}</td>
                                    <td>
                                        @if($value->file)
                                        <a href="{{ url('panel/sports/show/'. $value->id)}}" class="btn btn-primary btn-sm" target="_blank">{{ __('messages.show') }}</a>
                                        @else
                                    ...
                                    <td>
                                        <div class="action-dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                @hasPermission('Edit Specialist of Affairs and Sports')
                                                <li>
                                                    <a class="dropdown-item" href="{{ url('panel/sports/edit/'. $value->id) }}">
                                                        <i class="bi bi-pencil"></i> {{ __('messages.edit') }}
                                                    </a>
                                                </li>
                                                @endhasPermission
                                                @hasPermission('Delete Specialist of Affairs and Sports')
                                                <li>
                                                    <a class="dropdown-item text-danger" href="{{ url('panel/sports/delete/' .$value->id) }}"
...
<div class="filter-modal-overlay" id="filterModal">
    <div class="filter-modal">
        ...
        <div class="filter-modal-body">
            <form method="GET" action="{{ url('panel/sports') }}" id="filterForm">
                <div class="filter-row">
                    <!-- Sport Type Filter -->
                    <div class="filter-group">
                        <label class="filter-label">@lang('messages.sport_type')</label>
                        <select name="sport_type" class="form-control filter-select">
                            <option value="">@lang('messages.all_sport_types')</option>
                            @foreach($sportTypes as $type)
                                <option value="{{ $type }}" {{ request('sport_type') == $type ? 'selected' : '' }}>
                                    {{ $type }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <!-- Baget Filter -->
                    <div class="filter-group">
                        <label class="filter-label">@lang('messages.baget')</label>
                        <select name="baget" class="form-control filter-select">
                            <option value="">@lang('messages.all_baget')</option>
                            @foreach($bagetOptions as $option)
                                <option value="{{ $option }}" {{ request('baget') == $option ? 'selected' : '' }}>
                                    {{ $option }}
                                </option>
                            @endforeach
                        </select>
        ...
        <div class="filter-modal-footer">
            <div class="filter-results-badge">
                ...
                <span id="filterResultsText">
                    @if(request('sport_type') || request('baget'))
                        @lang('messages.filter_active')
                    @else
                        @lang('messages.showing_all_results')
                    @endif
                </span>
            </div>
...
<script>
    ...
    // Notes functionality
    const storageKey = 'temporaryNotes_sports'; // Unique key for this page
    let noteIdCounter = (() => {
