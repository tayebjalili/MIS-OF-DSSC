            ...
            <div class="card">
                <div class="card-body">
                    <div class="header-toolbar">
                        <h5 class="card-title mb-0" style="font-size: 14px;">{{ __('messages.specialist_of_cultural_services') }}</h5>

                        <div class="search-box">
                            <form method="GET" action="{{ url('panel/services') }}" class="d-flex w-100">
                        ...
                        <div class="utility-buttons">
                            ...
                            <form action="{{ route('backup.page', ['page' => 'services']) }}" method="GET">
                                <button type="submit" class="btn backup-btn">
                                    <i class="bi bi-box-arrow-down"></i> Backup
                                </button>
                            </form>

                            @hasPermission('Add Specialist of Cultural Services')
                            <a class="btn btn-success" href="{{ url('panel/services/add') }}">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover align-middle">
                            <thead class="table-light">
                                <tr>
                                    <th>
                                        <a href="{{ request()->fullUrlWithQuery(['sort_by' => 'id', 'order' => request('sort_by') === 'id' && request('order') === 'asc' ? 'desc' : 'asc']) }}">
                                            {{ __('messages.id') }}
                                    ...
                                    <th>
                                        <a href="{{ request()->fullUrlWithQuery(['sort_by' => 'start_date', 'order' => request('sort_by') === 'start_date' && request('order') === 'asc' ? 'desc' : 'asc']) }}">
                                    ...
                                    <th>
                                        <a href="{{ request()->fullUrlWithQuery(['sort_by' => 'end_date', 'order' => request('sort_by') === 'end_date' && request('order') === 'asc' ? 'desc' : 'asc']) }}">
                                    ...
                                    <th>
                                        <a href="{{ request()->fullUrlWithQuery(['sort_by' => 'report_type', 'order' => request('sort_by') === 'report_type' && request('order') === 'asc' ? 'desc' : 'asc']) }}">
                                    ...
                                    <th>
                                        <a href="{{ request()->fullUrlWithQuery(['sort_by' => 'report_explination', 'order' => request('sort_by') === 'report_explination' && request('order') === 'asc' ? 'desc' : 'asc']) }}">
                                    ...
                                    @hasPermission('Edit Specialist of Cultural Services')
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $value->report_explination}}</td>
                                    <td>
                                        @if($value->file)
                                        <a href="{{ url('panel/services/show/' . $value->id) }}" class="btn btn-primary btn-sm" target="_blank">{{ __('messages.show') }}</a>
                                        @else
                                    ...
                                    <td>
                                        <div class="action-dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                @hasPermission('Edit Specialist of Cultural Services')
                                                <li>
                                                    <a class="dropdown-item" href="{{ url('panel/services/edit/' . $value->id) }}">
                                                        <i class="bi bi-pencil"></i> {{ __('messages.edit') }}
                                                    </a>
                                                </li>
                                                @endhasPermission
                                                @hasPermission('Delete Specialist of Cultural Services')
                                                <li>
                                                    <a class="dropdown-item text-danger" href="{{ url('panel/services/delete/' . $value->id) }}"
...
<script>
    const storageKey = 'temporaryNotes_services'; // Unique key for this page
    let noteIdCounter = (() => {
