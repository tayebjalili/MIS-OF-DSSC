                    ...
                    <form action="{{ route('employment.update', $record->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                                ...
                                <textarea type="text" name="name" class="form-control" required>{{ $record->name }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                                ...
                                <textarea type="text" name="father_name" class="form-control" required>{{ $record->father_name }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                                ...
                                <textarea type="text" name="orientation_notes" class="form-control" required>{{ $record->orientation_notes }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                                ...
                                <textarea type="text" name="contracts_signed_with" class="form-control" required>{{ $record->contracts_signed_with }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                                ...
                                <textarea type="text" name="students_referred_for_jobs" class="form-control" required>{{ $record->students_referred_for_jobs }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                                ...
                                <textarea type="text" name="training_sessions" class="form-control" required>{{ $record->training_sessions }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                                ...
                                <textarea type="text" name="partner_organizations" class="form-control" required>{{ $record->partner_organizations }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                                ...
                                <textarea type="text" name="monthly_report" class="form-control" required>{{ $record->monthly_report }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                                ...
                                <textarea type="text" name="phone_number" class="form-control" required>{{ $record->phone_number }}</textarea>
                            </div>
                        </div>
