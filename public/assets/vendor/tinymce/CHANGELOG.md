...
- Added new charmap_append option that lets you Add characters to the default charmap of the charmap plugin.
...
- Added new table inline toolbar. Makes it easier to for example Add rows or columns to a table.
